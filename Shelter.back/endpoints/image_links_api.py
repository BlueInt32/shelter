...
from services.media_service import save_element_with_image_link
...
class ImageLinksApi(Resource):
    ...
    def post(self):
        ...
        new_element = save_element_with_image_link(PersistanceType.CREATE, args)
    ...
    def put(self, element_id):
        ...
        element = save_element_with_image_link(PersistanceType.UPDATE, args)

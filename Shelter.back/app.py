...
api.add_resource(ImageLinksApi, '/api/image-links', '/api/image-links/<element_id>')
api.add_resource(ImageFilesApi, '/api/image-files', '/api/image-files/<element_id>')
api.add_resource(VideoLinksApi, '/api/video-links', '/api/video-links/<element_id>')
api.add_resource(VideoFilesApi, '/api/video-files', '/api/video-files/<element_id>')
